...
> « En la antigüedad, quienes conocían el Camino seguían el Yin y el Yang, comían y bebían con moderación, se levantaban y dormían con regularidad, y no se agotaban con faenas inútiles. Así cuerpo y espíritu permanecían enteros, y alcanzaban el plenitud de sus cien años. »
>
...
- **Cuatro estaciones** (四季调养) — Primavera nace, verano crece, otoño cosecha, invierno almacena
...
Que cada visitante, tras leer un artículo, recuerde una sola frase —
y que esa frase le brinde algo de calor en una fría noche de invierno o en una tarde atribulada.

## Aviso

Todo el contenido de este sitio se ofrece **únicamente con fines educativos** y **no sustituye al diagnóstico ni al tratamiento médico**. Si no se encuentra bien, consulte a un profesional cualificado.

## Contacto

- Email: hello@example.com
- RSS: [Suscribirse](/es/feed.xml)

## Agradecimientos

Construido con [Jekyll](https://jekyllrb.com), tipografía en [Noto Serif SC](https://fonts.google.com/noto/specimen/Noto+Serif+SC) y [Ma Shan Zheng](https://fonts.google.com/specimen/Ma+Shan+Zheng) (Google Fonts).
Que la sabiduría de los siglos fluya libremente más allá de toda frontera.
