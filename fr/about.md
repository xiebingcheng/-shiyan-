...
Que chaque visiteur, après avoir lu un article, en retienne une seule phrase —
et que cette phrase lui apporte un peu de chaleur par une froide nuit d'hiver ou un après-midi troublé.
...
- RSS : [S'abonner](/fr/feed.xml)

## Remerciements

Site construit avec [Jekyll](https://jekyllrb.com), typographie en [Noto Serif SC](https://fonts.google.com/noto/specimen/Noto+Serif+SC) et [Ma Shan Zheng](https://fonts.google.com/specimen/Ma+Shan+Zheng) (Google Fonts).
Puisse la sagesse des âges couler librement par-delà toutes les frontières.
